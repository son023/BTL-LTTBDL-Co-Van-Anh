...
UPDATE phim SET
    ...
    dien_vien = 'Elijah Wood, Ian McKellen, Viggo Mortensen, Sean Astin, Orlando Bloom, Cate Blanchett, Hugo Weaving, Liv Tyler, John Rhys-Davies, Sean Bean.',
    do_dai = 178,
    do_tuoi = 13,
    hang_sx = 'New Line Cinema',
    mo_ta = 'The Lord of the Rings theo chân Frodo Baggins, người được giao nhiệm vụ tiêu diệt chiếc nhẫn quyền lực. Cùng với nhóm bạn, Frodo phải đối mặt với những nguy hiểm, bao gồm bóng tối từ Sauron. Họ chiến đấu chống lại cái ác để cứu lấy Trung Địa, vượt qua nhiều thử thách và hy sinh.',
    nam_sx = 2001,
    ngon_ngu = 'Tiếng Anh',
    poster = 'https://image.tmdb.org/t/p/original/uexxR7Kw1qYbZk0RYaF9Rx5ykbj.jpg',
    ten = 'The Lord of the Rings',
    the_loai = 'Phiêu lưu',
